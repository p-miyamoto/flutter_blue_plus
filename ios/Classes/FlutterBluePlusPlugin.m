...
- (void)handleMethodCall:(FlutterMethodCall*)call result:(FlutterResult)result {
  ...
  if ([@"state" isEqualToString:call.method]) {
    ...
    [self log:LogLevel.info format:@"getConnectedDevices periphs size: %lu", [periphs count]];
...
- (void)centralManager:(CBCentralManager *)central didConnectPeripheral:(CBPeripheral *)peripheral {
  ...
  [self log:LogLevel.info format:@"didConnectPeripheral"];
...
- (void)centralManager:(CBCentralManager *)central didDisconnectPeripheral:(CBPeripheral *)peripheral error:(NSError *)error {
  ...
  [self log:LogLevel.info format:@"didDisconnectPeripheral"];
...
- (void)peripheral:(CBPeripheral *)peripheral didDiscoverServices:(NSError *)error {
  ...
  [self log:LogLevel.info format:@"didDiscoverServices"];
  ...
  for(CBService *s in [peripheral services]) {
    ...
    [self log:LogLevel.info format:@"Found service: %@", [s.UUID UUIDString]];
...
- (void)peripheral:(CBPeripheral *)peripheral didDiscoverCharacteristicsForService:(CBService *)service error:(NSError *)error {
  ...
  [self log:LogLevel.info format:@"didDiscoverCharacteristicsForService"];
...
- (void)peripheral:(CBPeripheral *)peripheral didDiscoverDescriptorsForCharacteristic:(CBCharacteristic *)characteristic error:(NSError *)error {
  ...
  [self log:LogLevel.info format:@"didDiscoverDescriptorsForCharacteristic"];
...
- (void)peripheral:(CBPeripheral *)peripheral didDiscoverIncludedServicesForService:(CBService *)service error:(NSError *)error {
  ...
  [self log:LogLevel.info format:@"didDiscoverIncludedServicesForService"];
...
- (void)peripheral:(CBPeripheral *)peripheral didUpdateValueForCharacteristic:(CBCharacteristic *)characteristic error:(NSError *)error {
  ...
  [self log:LogLevel.info format:@"didUpdateValueForCharacteristic %@", [peripheral.identifier UUIDString]];
...
- (void)peripheral:(CBPeripheral *)peripheral didWriteValueForCharacteristic:(CBCharacteristic *)characteristic error:(NSError *)error {
  ...
  [self log:LogLevel.info format:@"didWriteValueForCharacteristic"];
...
- (void)peripheral:(CBPeripheral *)peripheral didUpdateNotificationStateForCharacteristic:(CBCharacteristic *)characteristic error:(NSError *)error {
  ...
  [self log:LogLevel.info format:@"didUpdateNotificationStateForCharacteristic"];
...
- (ProtosBluetoothService*)toServiceProto:(CBPeripheral *)peripheral service:(CBService *)service  {
  ...
  [self log:LogLevel.info format:@"peripheral uuid:%@, service uuid:%@", [peripheral.identifier UUIDString], [service.UUID fullUUIDString]];
  [result setRemoteId:[peripheral.identifier UUIDString]];
...
- (ProtosBluetoothCharacteristic*)toCharacteristicProto:(CBPeripheral *)peripheral characteristic:(CBCharacteristic *)characteristic {
  ...
  [self log:LogLevel.info format:@"uuid: %@ value: %@", [characteristic.UUID fullUUIDString], [characteristic value]];
