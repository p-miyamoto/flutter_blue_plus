...
class DeviceConnectionStatusResponse_BluetoothDeviceState extends $pb.ProtobufEnum {
  static const DeviceConnectionStatusResponse_BluetoothDeviceState DISCONNECTED = DeviceConnectionStatusResponse_BluetoothDeviceState._(0, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DISCONNECTED');
  static const DeviceConnectionStatusResponse_BluetoothDeviceState CONNECTING = DeviceConnectionStatusResponse_BluetoothDeviceState._(1, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'CONNECTING');
  static const DeviceConnectionStatusResponse_BluetoothDeviceState CONNECTED = DeviceConnectionStatusResponse_BluetoothDeviceState._(2, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'CONNECTED');
  static const DeviceConnectionStatusResponse_BluetoothDeviceState DISCONNECTING = DeviceConnectionStatusResponse_BluetoothDeviceState._(3, const $core.bool.fromEnvironment('protobuf.omit_enum_names') ? '' : 'DISCONNECTING');

  static const $core.List<DeviceConnectionStatusResponse_BluetoothDeviceState> values = <DeviceConnectionStatusResponse_BluetoothDeviceState> [
    DISCONNECTED,
    CONNECTING,
    CONNECTED,
    DISCONNECTING,
  ...
  static final $core.Map<$core.int, DeviceConnectionStatusResponse_BluetoothDeviceState> _byValue = $pb.ProtobufEnum.initByValue(values);
  static DeviceConnectionStatusResponse_BluetoothDeviceState? valueOf($core.int value) => _byValue[value];

  const DeviceConnectionStatusResponse_BluetoothDeviceState._($core.int v, $core.String n) : super(v, n);
}
